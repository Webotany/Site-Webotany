  ...
  if ($_SERVER["REQUEST_METHOD"] === 'POST') {
    if(isset($_POST["shopName"]) && isset($_POST["shopEmail"]) && isset($_POST["shopStock"]) && isset($_POST["shopCnpj"]) && !empty($_POST["shopName"]) && !empty($_POST["shopEmail"]) && !empty($_POST["shopStock"]) && !empty($_POST["shopCnpj"]))
    {
      ...
      if(isset($_SESSION['identifier']))
        $_SESSION['cart'][] = array($_SESSION['identifier'],$shopCnpj,$shopName,$shopEmail,$shopStock,2);
      else
        $_SESSION['cart'][] = array(0,$shopCnpj,$shopName,$shopEmail,$shopStock,2);
      header("Location: nephrolepisexaltata.php");
    }
    else
          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="width: 100%; height: 40vh;">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active" data-interval="5000">
                <img src="img/sell/samambaia/1.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item" data-interval="5000">
                <img src="img/sell/samambaia/2.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item" data-interval="5000">
                <img src="img/sell/samambaia/3.jpg" class="d-block w-100" alt="...">
              </div>
            </div>
